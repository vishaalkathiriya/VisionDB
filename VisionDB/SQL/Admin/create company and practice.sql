...
declare @CompanyName nvarchar(100) = 'Optician'
declare @CompanyAddress nvarchar(1000) = 'Nottingham' 
declare @CompanyPostcode nvarchar(100) = 'Postcode'
declare @CompanyTel nvarchar(100) = 'Tel'
declare @CreatedByUserId uniqueidentifier = '667cbe27-170b-42a0-92cb-18876ad2c8a2' --admin account Id
declare @CompanyRef nvarchar(4) = upper(substring(cast(@CompanyId as nvarchar(50)), 0, 5))

insert into Companies (Id, Name, Address, Postcode, Tel, CreatedByUser_Id, CompanyRef) 
values (@CompanyId, @CompanyName, @CompanyAddress, @CompanyPostcode, @CompanyTel, @CreatedByUserId, @CompanyRef)

-- create practice 1
declare @PracticeId uniqueidentifier = newid()
declare @PracticeName nvarchar(100) = @CompanyName
declare @PracticeAddress nvarchar(1000) = @CompanyAddress
declare @PracticePostcode nvarchar(100) = @CompanyPostcode
declare @PracticeTel nvarchar(100) = @CompanyTel
